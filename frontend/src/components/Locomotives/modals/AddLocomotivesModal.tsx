...
import styles from './AddLocomotivesModal.module.scss';

interface AddLocomotivesModalProps {
  open: boolean;
  onClose: () => void;
  onSubmit: () => void;
  formData: any;
...
const AddLocomotivesModal: React.FC<AddLocomotivesModalProps> = ({
  open,
  onClose,
  onSubmit,
  formData,
...
export default AddLocomotivesModal;